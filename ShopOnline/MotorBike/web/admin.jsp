                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <ul class="bread-list">
                                ...
                                <li><a href="admin.jsp"><%= loginUser.getFullName()%></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="contact-us-form-wrapper">
                                <div class="contact-us-form">
                                    ...
                                    <div class="form-group login-btn">
                                        <a class="btn" href="userControl.jsp"><img src="img/eye.png" alt="" class="eye-image"></a>
                                    </div>
                                </div>
                                <div class="contact-us-form">
                                    <h2>Product</h2>
                                    <img src="img/product.png" alt="">
                                    <a class="btn" href="productControl.jsp"><img src="img/eye.png" alt="" class="eye-image"></a>
                                </div>
                                ...
                                <div class="contact-us-form">
                                    ...
                                    <a class="btn" href="invoiceControl.jsp"><img src="img/eye.png" alt="" class="eye-image"></a>
                                </div>
                            </div>
                        </form>
                    </div>
