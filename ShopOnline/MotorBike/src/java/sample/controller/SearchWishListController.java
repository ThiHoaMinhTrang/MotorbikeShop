...
// * @author ADMIN
// */
//@WebServlet(name = "SearchWishListController", urlPatterns = {"/SearchWishListController"})
...
//            List<ProductDTO> ProductList = dao.getAllByMinMax2(minValue, maxValue, brand, loginUser.getUserId());
